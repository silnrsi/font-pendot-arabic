...
# $ git clone my-font
# $ cd my-font
# $ python3 documentation/proof.py --output documentation/proof.png

# Import models from external python packages: https://pypi.org/
...
FONT_PATH = "fonts/ttf/PendotATestA-Dotted.ttf"
FONT_LICENSE = "OFL v1.1"
AUXILIARY_FONT = "Gentium"
AUXILIARY_FONT_SIZE = 38

BIG_TEXT = "لمّا كان الاعتراف بالكرامة المتأصلة في جميع أعضاء الأسرة البشرية وبحقوقهم المتساوية الثابتة هو أساس الحرية والعدل والسلام في العالم."
BIG_TEXT_FONT_SIZE = 50
...
# For example: $ python3 documentation/proof.py --output documentation/proof.png
